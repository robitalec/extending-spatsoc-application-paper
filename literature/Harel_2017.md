...
> For each departure event, we calculated the mean roost departure time, variance among departure times and variance of departure directions (first GPS measurement outside the roost area).

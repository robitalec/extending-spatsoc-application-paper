...
the directional correlation delay, across `r taxized[covidence_number %in% dirr_del$covidence_number, uniqueN(species)]` study species. Only 
`r count_analysis_code_availability[covidence_number %in% dirr_del$covidence_number & V1 == 'Yes', .N]` study had code available for 

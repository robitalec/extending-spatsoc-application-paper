...
#| echo: true
#| eval: false
calc_dist_to_group_centroid(DT, coords, return_rank = TRUE)
calc_dir_to_group_centroid(DT, coords)
```
...
#| eval: true
#| warning: false
dist_dir_cent <- calc_dist_to_group_centroid(DT, coords, return_rank = TRUE)
dist_dir_cent <- calc_dir_to_group_centroid(DT, coords)
g1 <- ggplot(DT) +
...
#| echo: true
projection <- 32636
calc_az(DT, id = id, coords = coords, projection = projection)
...
#| eval: false
#| echo: true
calc_dist_to_leader(DT, coords = coords)
calc_dir_to_leader(DT, coords = coords)
```
...
#| echo: false
#| warning: false
DT <- calc_dist_to_leader(DT, coords = coords)
DT <- calc_dir_to_leader(DT, coords = coords)
...
#| eval: false
#| echo: true
# Fission fusion events using interinvidiual distance calculed with edge_dist
fusion_events <- fission_fusion(
...
fogo_min0_miss0_splitF <- fission_fusion(
  copy(sub_edges), threshold = spatial_threshold, n_min_length = 0, n_max_missing = 0, allow_split = FALSE)
fogo_min2_miss1_splitT <- fission_fusion(
  copy(sub_edges), threshold = spatial_threshold, n_min_length = 2, n_max_missing = 1, allow_split = TRUE)
fogo_min2_miss0_splitF <- fission_fusion(
  copy(sub_edges), threshold = spatial_threshold, n_min_length = 2, n_max_missing = 0, allow_split = FALSE)
...
#| echo: true
#| eval: false
# Calculate polarization using azimuth from calc_az_sequential()

...
#| eval: false
#| echo: true
distance_to_leader(DT, coords = coords, group = groupcol)
...
#| echo: false
#| warning: false
DT <- distance_to_leader(DT, coords = coords, group = groupcol)
...
g_dir <- ggplot(DT, aes(dist_leader, factor(rank_dist_group_bearing))) +
  stat_halfeye() +

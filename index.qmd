...
#| eval: true
#| echo: false
#| tbl-cap: "Measuring spatiotemporal group centroids with `centroid_group()`"
...
#| eval: true
#| warning: false
#| fig-cap: "Measuring distance and direction to group centroids with `distance_to_centroid()` and `direction_to_centroid()"
...
#| eval: true
#| echo: false
#| fig-cap: "Measuring position along front-back position within group with `leader_direction_group()`"
...
#| eval: true
#| echo: false
#| fig-cap: "Measuring distance and direction to group leader using `distance_to_leader()` and `direction_to_leader()`"
...
#| eval: true
#| fig-height: 10
#| fig-cap: "Identifying fusion events using `fusion_id()`"
...
#| eval: true
#| fig-height: 10
#| fig-cap: "Measuring direction polarization with `direction_polarization()`"

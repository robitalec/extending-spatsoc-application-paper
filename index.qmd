...
Here we present 
`r length(grep('cent|dir|dista|ali|del|zon', ls('package:spatsoc'), value = TRUE))` 
new functions for the R package {spatsoc} (Robitaille et al. 2019) for
measuring intragroup dynamics. We conducted a scoping review to identify metrics

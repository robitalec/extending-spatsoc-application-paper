...
group's direction (eg. [@Quera_2023; @Harel_2021; @Andrienko_2013]). The rank
position within group is the ordinal rank along the front-to-back axis of the
group's direction (eg. [@Burns_2012]). The time spent leading group is an
aggregate metric of the time in the first rank position within group. The
distance to leader is the geographic distance from the focal individual to the
group's leader. The direction to leader is the absolute direction from the focal
individual to the group's leader.

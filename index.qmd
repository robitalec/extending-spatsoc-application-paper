...
```{r}
#| label: tbl-group-pts
#| tbl-cap: "Spatiotemporal grouping with `group_pts()` using the new geometry interface"
#| echo: false
...
#| echo: false
#| eval: true
#| tbl-cap: "Measuring interindividual distances with `edge_dist()`"
...
#| echo: false
#| eval: true
#| tbl-cap: "Measuring nearest neighbours with `edge_nn()`"
